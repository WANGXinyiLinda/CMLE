...
def parse_opt():
    ...
    parser.add_argument('--use_hal', action='store_true',
                    help='True if we want to use hallucinated captions')
    ...
    parser.add_argument('--hal_cap_files', type=str, default='none',
                    help='path to the json file containing generated (halucinated) captions separated by ,')
    ...
    parser.add_argument('--hal_per_batch', type=int, default=16,
                    help='number of hallucinated captions to sample for each batch during training. Since we have significantly smaller number of hallucinated sentences, this can keep the balance a little.')
    ...
    parser.add_argument('--weight_decay', type=float, default=0,
                    help='weight_decay')
    parser.add_argument('--counterfactual_training_start', type=int, default=-1, 
                    help='at what iteration to start counterfactual training? (-1 = dont) (in epoch)')
    ...
    # Conterfactual loss
    parser.add_argument('--ipm_alpha', type=float, default=-1,
                    help='weight for IPM regularizer. To disable ipm loss, set ipm_alpha to -1. Only make sense for transformers.')
    parser.add_argument('--gumbel_alpha', type=float, default=-1,
                    help='weight for counterfactual examples. To disable this loss, set gumbel_alpha to -1.')
    parser.add_argument('--clf_path', type=str, default=None,
                    help='path to the fine tuned lxmert classifier')

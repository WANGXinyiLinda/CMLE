...
# chair eval
imids = [loader.dataset.info['images'][i]['id'] for i in loader.dataset.split_ix[opt.split]]
CHAIRevaluator = CHAIR(imids, opt.annotation_path) 
CHAIRevaluator.get_annotations()

# Set sample options
opt.dataset = opt.input_json
loss, split_predictions, lang_stats = eval_utils.eval_split(model, crit, loader, CHAIRevaluator, vars(opt))

...
class LXRTEncoder(nn.Module):
    ...
    def forward(self, sents=None, feats=None, visual_attention_mask=None, 
        input_word_embeddings=None, input_mask=None, segment_ids=None):
        if sents is not None:
            ...
            output = self.model(input_ids, segment_ids, None, input_mask,
                                visual_feats=feats,
                                visual_attention_mask=visual_attention_mask)
        elif input_word_embeddings is not None:
            output = self.model(None, segment_ids, input_word_embeddings, input_mask,
                                visual_feats=feats,
                                visual_attention_mask=visual_attention_mask)
        else:
